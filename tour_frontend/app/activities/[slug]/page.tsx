      ...
      <div className="mx-auto max-w-[1400px] px-6 py-10">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[minmax(0,1fr)_320px]">
            ...
            <header>
              ...
              <div className="mt-3 flex flex-wrap items-center gap-2 text-sm text-[#6B7280]">
                ...
                <span className="inline-flex items-center gap-1.5">
                  ...
                  {(activity.views ?? activity.view_count ?? 0).toLocaleString()} views
                </span>
              </div>
              <div className="mt-4">
                <ShareButtons
          ...
          <aside className="lg:sticky lg:top-24 lg:self-start">
            <div className="flex flex-col rounded-xl border border-[#E5E7EB] bg-white p-4 lg:h-[calc(100vh-7rem)]">
