    ...
    <footer className="bg-[#0078C0] text-white">
      <div className="mx-auto max-w-[1240px] px-6 py-8">
        <div className="grid grid-cols-1 gap-8 border-b border-white/30 pb-7 lg:grid-cols-[1.1fr_1fr]">
          <div>
            <h3 className="font-display text-2xl font-semibold">Get Social With Us</h3>
            <div className="mt-3 flex items-center gap-3">
              <a href="#" className="rounded-full border border-white/50 p-1.5 hover:bg-white/20">
        ...
        <div className="grid grid-cols-1 gap-7 py-7 md:grid-cols-[1.3fr_1fr_1fr_1fr]">
          <div>
            <div className="mb-3 flex items-center gap-2">
              <Image src="/logo.webp" alt="Paayo Nepal" width={34} height={34} />
              <span className="font-display text-xl font-semibold">Paayo Nepal</span>
            </div>
            <p className="max-w-sm text-sm text-white/85">
              Travel stories, region guides, events, and tourism updates from Nepal.
            </p>
            <div className="mt-4 space-y-2 text-sm text-white/85">
              ...
              <p className="flex items-center gap-2">
                <Mail className="h-4 w-4" /> info@paayonepal.com
              </p>
            </div>
          </div>

          <div>
            <h4 className="text-sm font-semibold uppercase tracking-[0.08em] text-white">Quick Links</h4>
            <ul className="mt-3 space-y-2 text-sm text-white/85">
              <li><Link href="/" className="hover:text-white">Home</Link></li>
              <li><Link href="/regions" className="hover:text-white">Regions</Link></li>
          ...
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-[0.08em] text-white">Discover</h4>
            <ul className="mt-3 space-y-2 text-sm text-white/85">
              <li><Link href="/events" className="hover:text-white">Events</Link></li>
              <li><Link href="/videos" className="hover:text-white">Videos</Link></li>
              <li><Link href="/photos" className="hover:text-white">Photos</Link></li>
              <li><Link href="/articles" className="hover:text-white">Articles</Link></li>
            </ul>
          </div>

          <div>
            <h4 className="text-sm font-semibold uppercase tracking-[0.08em] text-white">Company</h4>
            <ul className="mt-3 space-y-2 text-sm text-white/85">
        ...
        <div className="border-t border-white/25 pt-4 text-xs text-white/75">
          Copyright © {new Date().getFullYear()} Paayo Nepal. All rights reserved.
        </div>
      </div>
    </footer>
  );
